...
const apiUrlLoc = `http://api.openweathermap.org/geo/1.0/direct?q=${cityname}&appid=${APIkeyLoc}`;
...
//
  ...
  console.log('Temperature in Celsius:', temperatureCelsius.toFixed(2),dataWea);
      });
